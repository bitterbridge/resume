...
\newcommand{\contactinfoitem}[4]{#1\hspace{0.5em}\href{#2 #3}{#4}}
...
\newcommand{\myemailcontact}{\contactinfoitem{\faAt}{mailto:}{\myemail}{\myemail}}
...
\newcommand{\myphonecontact}{\contactinfoitem{\faPhone}{tel:}{\myphone}{\myphone}}

% My website URL.
\newcommand{\mywebsiteurl}{https://darkdell.net}
\newcommand{\mywebsitecontact}{\contactinfoitem{\faGlobe}{}{\mywebsiteurl}{darkdell.net}}

% My LinkedIn URL.
\newcommand{\mylinkedinurl}{https://www.linkedin.com/in/nug-doug}
\newcommand{\mylinkedincontact}{\contactinfoitem{\faLinkedin}{}{\mylinkedinurl}{nug-doug}}

% My GitHub URL.
\newcommand{\mygithuburl}{https://github.com/ndouglas/}
\newcommand{\mygithubcontact}{\contactinfoitem{\faGithub}{}{\mygithuburl}{ndouglas}}
...
\newcommand{\myheader}{%
  ...
  % information should occupy the rest of the page.
...
\newcommand{\resumeemployer}[2]{%
  % Use a tabularx to make the table fill the entire width of the page.
